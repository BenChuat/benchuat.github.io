...
date = "2026-01-22T11:29:07.224859+08:00"
lang = "zh-cn"
draft = false
slug = "20260122112907"
categories = []
...
![287def8936430f4f6f8ac4ad921ce1a5](http://blog.benchuat.cn:8089/u7iTL7.jpg)
...
<img src="http://blog.benchuat.cn:8089/S0YhrS.png" alt="image-20260118203750857" style="zoom: 33%;" />
...
<img src="http://blog.benchuat.cn:8089/3bHHXA.png" alt="image-20260116144506911" style="zoom:67%;" />
...
![image-20260118203926693](http://blog.benchuat.cn:8089/OJfzui.png)
...
2. **按 RESET 键**：
   ...
   <img src="http://blog.benchuat.cn:8089/5DAq73.png" alt="image-20260118204311921" style="zoom:33%;" />
...
![image-20260118204656183](http://blog.benchuat.cn:8089/F34TxB.png)
...
<img src="http://blog.benchuat.cn:8089/srif8l.png" alt="image-20260118205821623" style="zoom:50%;" />
...
![image-20260118211805769](http://blog.benchuat.cn:8089/a3a99O.png)

#### 硬件连接步骤

1. **使用 LVDS 线缆连接**：
   
   <img src="http://blog.benchuat.cn:8089/pSuUYe.png" alt="image-20260118195759366" style="zoom:25%;" /><img src="http://blog.benchuat.cn:8089/U3BH3v.png" alt="3227445ab80a9614077b9967d5ca704c" style="zoom: 25%;" />

   - 将 IWR6843ISK-ODS 的 LVDS 接口与 DCA1000EVM 的对应接口连接
   - 确保连接牢固，接触良好
   
   <img src="http://blog.benchuat.cn:8089/sPaI46.jpg" alt="b552aa8ccac434fce20c302fa7e8c3f0" style="zoom:50%;" />
...
2. **连接电源 - DCA1000EVM 供电设置**：
   ...
   **方式二：由 IWR6843ISK-ODS 板通过 60 针连接器供电**
   ...
   <img src="http://blog.benchuat.cn:8089/3CTL5x.png" alt="9230581104d016036d2b053762f0c5fd" style="zoom: 50%;" />
   ...
   <img src="http://blog.benchuat.cn:8089/JsaxOR.png" alt="image-20260118195959400" style="zoom: 33%;" />
...
![image-20260118212237869](http://blog.benchuat.cn:8089/n2eiBf.png)

   - 选择「Internet 协议版本 4 (TCP/IPv4)」→「属性」

<img src="http://blog.benchuat.cn:8089/PiFhJz.png" alt="image-20260118212345213" style="zoom:50%;" />
   ...
   - 选择「使用下面的 IP 地址」，设置：
     ...
     <img src="http://blog.benchuat.cn:8089/KkaS2f.png" alt="image-20260118212425060" style="zoom:50%;" />
...
![image-20260118213622680](http://blog.benchuat.cn:8089/eaOqGK.png)

### 6.2 检查串口

连接都正确后，电脑打开设备管理器，查看串口，应该能看到两个设备的串口信息。

![image-20260118215226288](http://blog.benchuat.cn:8089/Y3YXep.png)

如果没有的话，去手动安装一下驱动。（路径：C:\ti\mmwave_studio_02_01_01_00\ftdi）
![image-20260118215601192](http://blog.benchuat.cn:8089/SLmaaG.png)
...
![image-20260118220132566](http://blog.benchuat.cn:8089/NpoKwb.png)
...
![image-20260118220051104](http://blog.benchuat.cn:8089/yxkjxH.png)
...
![image-20260118221123750](http://blog.benchuat.cn:8089/zt5Cqw.png)
...
![image-20260118221403119](http://blog.benchuat.cn:8089/BfoIDo.png)
...
1. **配置 DCA1000 网络参数**：
   ...
   ![image-20260119111724251](http://blog.benchuat.cn:8089/4FXuFF.png)
...
2. **确认 FPGA 版本号**：
   ...
   ![image-20260119111658598](http://blog.benchuat.cn:8089/OLotX5.png)
...
![image-20260119103111820](http://blog.benchuat.cn:8089/i4Gntd.png)
...
![image-20260119103352154](http://blog.benchuat.cn:8089/ayPR4r.png)

### 7.5 SensorConfig（传感器配置）

SensorConfig 是传感器配置的核心部分，包含三个关键参数配置：

![image-20260119110856959](http://blog.benchuat.cn:8089/xDrgTx.png)
...
![image-20260119105605686](http://blog.benchuat.cn:8089/HcUgna.png)
...
![image-20260119105826982](http://blog.benchuat.cn:8089/ZSx221.png)
...
![image-20260119110631173](http://blog.benchuat.cn:8089/L4ZlyZ.png)
...
![image-20260119111151388](http://blog.benchuat.cn:8089/HzVyJM.png)
...
- 点击6后等待2秒后点击7点击Trigger Frame，LED灯DATA_TRAN_RPG绿光不停闪烁，表明正在获取数据。
  ...
  ![image-20260119115101666](http://blog.benchuat.cn:8089/SBKthc.png)
...
- 数据文件保存在 mmWave Studio 中指定的路径，通常是：C:\ti\mmwave_studio_02_01_01_00\mmWaveStudio\PostProc
  ...
  ![image-20260119173813658](http://blog.benchuat.cn:8089/gU72mN.png)
